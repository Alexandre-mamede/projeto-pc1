    ...
    do
    {
        ...
        case 2:
            do
            {
                ...
                case 2:
                    consultar_produto(depositos, totalDepositos);
                    break;

                case 3:
                    atualiza_produto(depositos, totalDepositos);
                    break;

                case 4:
                    remover_produto(depositos, totalDepositos);
                    break;

                case 5:
                    transferir_produto(depositos, totalDepositos);
                    break;
                }
